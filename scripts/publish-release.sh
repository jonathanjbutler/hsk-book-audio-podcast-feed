...
echo "Feed: https://jonathanjbutler.github.io/hsk-book-audio-podcast-feed/feed.xml"
echo ""
echo "Subscribe in Overcast:"
echo "  https://jonathanjbutler.github.io/hsk-book-audio-podcast-feed/feed.xml"
echo "=========================================="
